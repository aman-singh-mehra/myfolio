    ...
    return(
        <div className="aali_tm_section">
            <div className="aali_tm_skills">
                        ...
                        <div className="right wow fadeInRight" data-wow-duration="1s">
                            <div className="dodo_progress">
                                <div className="progress_inner" data-value="86">
                                    <span><span className="label">Website Design</span><span className="number">86%</span></span>
                                    <div className="background"><div className="bar"><div className="bar_in"></div></div></div>
                                </div>
                                <div className="progress_inner" data-value="90" >
                                    <span><span className="label">Mobile Application</span><span className="number">90%</span></span>
                                    <div className="background"><div className="bar"><div className="bar_in"></div></div></div>
                                </div>
                                <div className="progress_inner" data-value="66">
                                    <span><span className="label">Game Programming</span><span className="number">66%</span></span>
                                    <div className="background"><div className="bar"><div className="bar_in"></div></div></div>
                                </div>
                            </div>
                        </div>
                ...
                <span className="border moving_effect" data-direction="x" data-reverse="yes"></span>
            </div>
        </div>
    )
}
